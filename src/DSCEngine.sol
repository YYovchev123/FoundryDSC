...
contract DSCEngine is ReentrancyGuard {
    ...
    /**
     * @param tokenCollateralAddress The address of the tokne to deposit collateral
     ...
     * @notice You wil get a liquidation bonus for taking users funds.
     * @notice This function working assumes the portocol will be roughly 200% overcollateralized in order for this to work.
     * @notice A know bug would be if the portocol were 100% or less collateralized, then we wouldn't be able to incentive the liquidator.
        ...
        nonReentrant
    {
        ...
        // We should implement a feature to liquidate in the event the portocol is insolvent
